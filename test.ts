...
@Component({
  selector: 'app-cognitive-level',
  templateUrl: './cognitive-level.component.html',
  styleUrls: ['./cognitive-level.component.scss', '../aqar.styles.scss'],
})
export class RoomComponent implements OnInit {
  ...
  async GetDocTypes() {
    this.dataSource.data = await this.Api.readdata();
  }
